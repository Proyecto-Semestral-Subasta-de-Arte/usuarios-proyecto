...
public class UsuarioController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "Prohibido - Se requiere rol de ADMIN")
    })
    ...
    @GetMapping("/rol/{rol}")
    @Operation(summary = "Listar usuarios por rol", description = "Obtiene una sublista de usuarios filtrada de acuerdo al rol ingresado.")
    @ApiResponses(value = {
